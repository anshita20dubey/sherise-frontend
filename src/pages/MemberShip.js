            ...
            <div className="flex-grow pt-16">
                ...
                <div className="py-6 sm:py-10 bg-gradient-to-r from-emerald-500 to-teal-600">
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        ...
                        <p className="mt-2 sm:mt-4 text-center text-white text-lg sm:text-xl max-w-2xl mx-auto px-2">
                            Exclusive access to mentorship from successful women leaders.<br/> Opportunities for networking, business collaborations, and funding
                        </p>
                ...
                <div className="w-full max-w-3xl mx-auto px-4 py-6 sm:py-10">
                    <div className="bg-black/50 rounded-lg shadow-xl p-4 sm:p-6 md:p-8 mb-8 border border-gray-700 transition-all hover:shadow-green-900/20">
                        <h2 className="text-xl sm:text-2xl font-semibold text-green-400 mb-4 sm:mb-6">Join Our Community</h2>
                        <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center mb-4">
                            <p className="text-gray-300 text-sm sm:text-base leading-relaxed">
                                Please join our worldwide network and support women and the localization industry. Participate in chapter or virtual events, subscribe to our newsletter, advance your career, and connect with peers from all over the world.
                            </p>
                        </div>
                        <div className="p-3 sm:p-4 bg-gray-800 rounded-md border-l-4 border-green-400 mb-6 text-sm sm:text-base">
                            <p className="text-gray-200">
                                <span className="font-medium text-green-300">Important:</span> Please sign up with your personal email, not your work or school email, to ensure continued access to your Sherise Club membership if you change jobs or finish school.
                            </p>
                        </div>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-6">
                            ...
                            <div className="grid grid-cols-1 gap-y-4 sm:gap-y-6 gap-x-4 sm:grid-cols-2">
                                <div>
                                    <label htmlFor="firstName" className="block text-sm font-medium text-green-300 mb-1">
                                ...
                                <div>
                                    <label htmlFor="lastName" className="block text-sm font-medium text-green-300 mb-1">
                            ...
                            <div>
                                ...
                                <p className="mt-1 text-xs sm:text-sm text-gray-400 italic">Please use your personal email, not your work or school email.</p>
                            </div>

                            {/* Job Function */}
                            <div>
                                <label htmlFor="jobFunction" className="block text-sm font-medium text-green-300 mb-1">
                            ...
                            {/* Vertical */}
                            <div>
                                <label htmlFor="vertical" className="block text-sm font-medium text-green-300 mb-1">
                            ...
                            <div className="p-4 sm:p-6 bg-black/50  rounded-lg border border-gray-600 shadow-inner">
                                <p className="block text-sm font-medium text-green-300 mb-2 sm:mb-3">Areas of Interest</p>
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-2 sm:gap-3">
                                    {[
                                        { id: "interest-news", value: "industry-news", label: "Learn about industry news and trends" },
                                        { id: "interest-recruitment", value: "recruitment", label: "Recruitment" },
                                        { id: "interest-connect", value: "network", label: "Connect to our network of professionals" },
                                        { id: "interest-events", value: "events", label: "Keep up with Chapter events" },
                                        { id: "interest-mentor", value: "mentor", label: "Become a mentor/Find a mentor" },
                                        { id: "interest-volunteer", value: "volunteer", label: "Become a Sherise Club volunteer" },
                                        { id: "interest-business", value: "business", label: "Sales/Business development" },
                                        ...
                                        <div key={interest.id} className="flex items-start">
                                            ...
                                            />
                                            <label htmlFor={interest.id} className="ml-2 sm:ml-3 block text-xs sm:text-sm text-gray-300">
                                                {interest.label}
                                            </label>
                                        </div>
                                    ))}
                            ...
                            {/* Source */}
                            <div>
                                <label htmlFor="hearAbout" className="block text-sm font-medium text-green-300 mb-1">
                                ...
                                <div className="flex items-start">
                                    ...
                                    <div className="ml-2 sm:ml-3 text-xs sm:text-sm">
                                        <label htmlFor="emailPermission" className="text-gray-300">
                                            I agree to receive newsletters and updates from Sherise Club
                                        </label>
                                    </div>
                                </div>
                            </div>
