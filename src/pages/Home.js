        ...
        <div className="relative w-full font-sans">
            ...
            <section ref={homeRef} id="home" className="relative h-screen w-full overflow-hidden">
                ...
                <div className="absolute inset-0 flex flex-col items-center justify-center px-4 sm:px-6 md:px-8 text-center">
                    <h1 className={`text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-bold text-white mb-4 sm:mb-6 transition-all duration-700 ${animationComplete ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'
                        }`}>
                        Welcome To<br />
                        <span className="text-emerald-400">SheRise Club</span>
                    </h1>

                    <p className={`text-base sm:text-lg md:text-xl lg:text-2xl text-white/90 max-w-2xl mx-auto transition-all duration-700 delay-150 ${animationComplete ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'
                        }`}>
                        Empowering Women, Enabling Growth. Join a powerful network of women leaders, entrepreneurs, and professionals dedicated to uplifting and supporting women across Madhya Pradesh.
                    </p>

                    <div className={`mt-6 sm:mt-8 md:mt-10 lg:mt-12 flex gap-4 transition-all duration-700 delay-300 ${animationComplete ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'
                        }`}>
                    </div>
                </div>
            ...
            <section ref={statsRef} id="stats" className="w-full bg-black text-white py-12 sm:py-16">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6 md:gap-8 mb-16 sm:mb-20 md:mb-24">
                        ...
                        <div className={`flex flex-col items-center p-4 transition-all duration-700`}>
                            ...
                            <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-white mb-1 sm:mb-2">{counts.members.toLocaleString()}</h2>
                        ...
                        <div className={`flex flex-col items-center p-4 transition-all duration-700 `}>
                            ...
                            <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-white mb-1 sm:mb-2">{counts.visitors}</h2>
                            <p className="text-sm sm:text-base text-gray-400">Daily Visitors</p>
                        </div>
                        ...
                        <div className={`flex flex-col items-center p-4 transition-all duration-700`}>
                            ...
                            <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-white mb-1 sm:mb-2">{counts.programs}</h2>
                            <p className="text-sm sm:text-base text-gray-400">Health Program</p>
                        </div>
                        ...
                        <div className={`flex flex-col items-center p-4 transition-all duration-700 `}>
                            ...
                            <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-white mb-1 sm:mb-2">{counts.impact.toLocaleString()}</h2>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 items-center">
                        ...
                        <div className={`transition-all duration-1000 `}>
                            ...
                            <p className="text-gray-400 mb-6 sm:mb-8 leading-relaxed">
                                To create a dynamic ecosystem where women help women—mentoring, networking, and enabling each other to achieve personal and professional growth. <br className="hidden md:block" />
                                Join a powerful network of women leaders, entrepreneurs, and professionals dedicated to uplifting and supporting women across Madhya Pradesh.
                            </p>
                            <button
            ...
            < section ref={quickHelpRef} id="quickHelp" className="py-16 sm:py-20 md:py-24 bg-gradient-to-b from-[#181818] to-[#0d0d0d]" >
                <div className="max-w-7xl mx-auto px-4 sm:px-6">
                    ...
                    <div className="max-w-xl mx-auto bg-black/50 p-4 sm:p-6 md:p-8 rounded-lg border border-emerald-400/20 shadow-lg shadow-emerald-400/5">
                        {/* Status Message */}
                        {helpSubmitStatus && (
                            <div className={`mb-4 sm:mb-6 p-3 sm:p-4 rounded-md ${helpSubmitStatus.type === 'success'
                                ? 'bg-emerald-400/20 border border-emerald-400/30 text-emerald-400'
                                : 'bg-red-400/20 border border-red-400/30 text-red-400'
                                }`}>
                                <p className="text-xs sm:text-sm font-medium">{helpSubmitStatus.message}</p>
                            </div>
                        )}

                        <form className="space-y-4 sm:space-y-6" onSubmit={handleHelpSubmit}>
                            <div>
                                <label htmlFor="helpName" className="block text-xs sm:text-sm font-medium text-gray-300 mb-1">Your Name</label>
                                <input
                                    type="text"
                                    id="helpName"
                            ...
                            <div>
                                <label htmlFor="helpEmail" className="block text-xs sm:text-sm font-medium text-gray-300 mb-1">Email Address</label>
                                <input
                                    type="email"
                                    id="helpEmail"
                                    className="w-full px-3 sm:px-4 py-2 sm:py-3 border border-gray-700 bg-black/70 text-white rounded-md focus:outline-none focus:ring-2 focus:ring-emerald-400 transition-all text-sm sm:text-base"
                            ...
                            <div>
                                <label htmlFor="helpQuestion" className="block text-xs sm:text-sm font-medium text-gray-300 mb-1">Your Question</label>
                                <textarea
                                    id="helpQuestion"
                                    rows="4"
                                    className="w-full px-3 sm:px-4 py-2 sm:py-3 border border-gray-700 bg-black/70 text-white rounded-md focus:outline-none focus:ring-2 focus:ring-emerald-400 transition-all text-sm sm:text-base"
